  ...
  <div class="bg">
    ...
    <div class="from">
      <el-form :model="ruleForm"  ref="ruleForm" label-width="0" class="demo-ruleForm">
         <el-form-item label="" prop="user" :rules="{required: true, message: '请输入用户名', trigger: 'blur'}">
          <div class="inputbox">
            <icon-svg  :iconClss="'zhanghao-m'" class="username"></icon-svg>
            <input type="text" @keyup.13="submitForm('ruleForm')" v-model="ruleForm.user" >
          </div>
        </el-form-item>
        <el-form-item label="" prop="password" :rules="{required: true, message: '请输入密码', trigger: 'blur'}">
          <div  class="inputbox">
            <icon-svg :iconClss="'mima'" class="password"></icon-svg>
            <input type="password" @keyup.13="submitForm('ruleForm')"  v-model="ruleForm.password" >
          </div>
        </el-form-item>
        <el-form-item>
      ...
      <!-- <input type="text" style="background-color:transparent; border-width:1;color:white;outline:none;">
      <el-input style="background-color:transparent; border-width:1;"></el-input> -->
    </div>
  </div>
</template>
<script>
